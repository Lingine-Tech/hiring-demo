...
本测试用于 60 分钟技术面试，采用**三步流程**，详见 [README.md](./README.md) 的「三步评估流程」。本文件聚焦第二步涉及的**任务子项达成标准**。

### 测试模式
- 时间: 60 分钟
- 三步流程:
  1. **Review 现有代码** → 产出 `REVIEW.md`
  2. **写 Feature（需录屏）** → 从下方子项自选实现，并录制与 AI 助手交互过程
  3. **Review 自写代码** → 挑 2–4 个关键点讲解实现思路
